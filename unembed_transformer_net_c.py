...
class Generator(nn.Module):
    def __init__(self, d_model, batchsize, classVariety):
        # 词嵌入维度 词表大小
...
# 构建模型
def make_model(source_vocab, target_vocab, N=6, d_model=1024, d_ff=1024, head=8, batchsize=20, dropout=0.1):
    ...
    model = EncoderDecoder(
            ...
            nn.Sequential(c(position)),
            Generator(d_model, batchsize, target_vocab)
